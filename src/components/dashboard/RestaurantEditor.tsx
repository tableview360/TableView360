...
export default function RestaurantEditor() {
  ...
  if (!restaurant) {
    return <div className="text-center py-10 text-slate-500">No tienes restaurante asignado</div>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-700/40 bg-slate-800/80 p-6">
        <h2 className="text-lg font-semibold text-slate-100 mb-4">Datos del restaurante</h2>
      ...
      <div className="rounded-2xl border border-slate-700/40 bg-slate-800/80 p-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold text-slate-100">Fotos del restaurante</h2>
        ...
        {photos.length > 0 ? (
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {photos.map((photo) => (
              <div key={photo.id} className="group relative aspect-square overflow-hidden rounded-xl bg-slate-700">
